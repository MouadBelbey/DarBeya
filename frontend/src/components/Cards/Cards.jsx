  ...
  return (
    <div className='col'>
            <div className="card border-0 transform-on-hover">
                <a href="#" className="lightbox" data-bs-toggle="modal" data-bs-target={`#${modalId}`}><img src={src} className='card-img-top' alt={alt} /></a>
            ...
            <div className="modal-dialog modal-lg">
                ...
                <div id={carouselId} className="carousel slide">
                  ...
                  <div key={index} className={`carousel-item ${index === 0 ? 'active' : ''}`}>
                    <img src={carouselImage} className="carousel_img d-block w-100" alt={alt} />
                  </div>
                ))}
                    </div>
