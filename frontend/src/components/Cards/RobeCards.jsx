...
function RobeCards({id, src, title, alt, description, couleur, categorie, carouselImages}) {
            ...
            >
                ...
                <div className="product-card-body">
                    ...
                    <div className="product-details">
                        {couleur && <span className="product-color">Couleur: {couleur}</span>}
                        {categorie && <span className="product-category">Catégorie: {categorie}</span>}
                    </div>
                </div>
            </div>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="product-modal-details">
                                ...
                                <div className="product-specs">
                                    {couleur && <p><strong>Couleur:</strong> {couleur}</p>}
                                    {categorie && <p><strong>Catégorie:</strong> {categorie}</p>}
                                </div>
                            </div>
                        </div>
